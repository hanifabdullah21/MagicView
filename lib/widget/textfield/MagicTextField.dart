...
class MagicTextField extends StatefulWidget {
  ...
  MagicTextField(this.controller,
      {super.key,
      this.keyboardType,
  ...
  MagicTextField.password(this.controller,
      {super.key,
      this.keyboardType,
      this.textInputAction,
      this.textStyle,
  ...
  MagicTextField.border(this.controller,
      {super.key,
      this.keyboardType,
      this.textInputAction,
      this.textStyle,
  ...
  MagicTextField.borderPassword(this.controller,
      {super.key,
      this.keyboardType,
      this.textInputAction,
      this.textStyle,
